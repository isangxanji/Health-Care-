...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .nav a.active { background: rgba(37, 99, 235, 0.18); color: #fff; }
    .nav .icon {
      width: 1.25rem;
      display: inline-grid;
      place-items: center;
    ...
    .help-logout { display: grid; gap: 0.25rem; }
    .help-logout a {
      display: flex; align-items: center; gap: 0.6rem;
      padding: 0.6rem 0.75rem; border-radius: 10px; color: var(--sidebar-text); text-decoration: none;
    }
    ...
    .topbar .title-wrap { display: grid; gap: 0.25rem; }
    ...
    .avatar {
      width: 36px; height: 36px; border-radius: 50%; background: #c7d2fe;
    ...
    .stat .value { font-size: 1.8rem; font-weight: 700; letter-spacing: 0.5px; }
    .stat.upcoming .value { color: var(--primary); }
    .stat.completed .value { color: var(--success); }
    .stat.cancelled .value { color: var(--danger); }

    .actions { grid-template-columns: repeat(3, minmax(220px, 1fr)); }
    ...
    .btn {
      ...
      font-weight: 600;
      cursor: pointer;
      transition: border-color 0.15s, background 0.15s, transform 0.02s;
      text-align: left;
    }
    ...
    <main class="main">
      <div class="topbar">
        <div class="title-wrap">
          <h2>Dashboard</h2>
          <p>Welcome, Min Gyu! Here's an overview of your appointments and activity</p>
        </div>
        <div class="user-info" aria-label="Current user">
          <div class="avatar" aria-hidden="true">MG</div>
          <div>
            <div class="name">Min Gyu</div>
            <small style="color: var(--muted);">Patient</small>
          </div>
        </div>
      </div>
      ...
      <section class="grid stats" aria-labelledby="stats-title">
        <h2 id="stats-title" style="position:absolute;left:-9999px;">Appointment statistics</h2>
